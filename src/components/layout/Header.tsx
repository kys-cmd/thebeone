        ...
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex flex-1 items-center justify-center px-8">
            ...
            <nav className="flex items-center gap-8 text-[15px] font-bold text-gray-700">
              ...
              <Link to="/live" className="hover:text-purple-600 transition-colors flex items-center gap-1">
                <span>비원Live</span>
                  ...
                  <div className="flex flex-col h-full bg-white">
                    ...
                    <div className="flex-1 overflow-y-auto py-6 px-4">
                      <nav className="flex flex-col gap-2">
                        ...
                        <Link to="/live" className="flex items-center gap-3 p-4 rounded-xl hover:bg-purple-50 transition-colors font-bold text-gray-700">
